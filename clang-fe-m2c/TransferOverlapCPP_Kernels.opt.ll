; ModuleID = 'TransferOverlapCPP_Kernels.opt.bc'
...
; <label>:40                                      ; preds = %39
  %41 = add i32 %i.0, 1
  %42 = call i32 @__get_global_size_u32(i32 0)
  %43 = add i32 %idx.0, %42
  br label %9
...
; <label>:47                                      ; preds = %5
  ...
  call void @barrier(i32 1)
  %49 = call i32 @__get_local_id_u32(i32 0)
  %50 = icmp eq i32 %49, 0
...
; <label>:19                                      ; preds = %17
  %20 = call i32 @__get_global_id_u32(i32 0)
  br label %21
...
; <label>:25                                      ; preds = %23
  %26 = add i32 %i.0, 1
  %27 = call i32 @__get_global_size_u32(i32 0)
  %28 = add i32 %idx.0, %27
  br label %21
