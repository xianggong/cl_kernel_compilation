...
; <label>:3                                       ; preds = %0
  %4 = call i32 @__get_local_id_u32(i32 0)
  %5 = icmp eq i32 %4, 0
...
; <label>:14                                      ; preds = %12
  ...
  %16 = load volatile <4 x i32> addrspace(1)* %15, align 16
...
; <label>:21                                      ; preds = %19, %14
  ...
  %23 = load volatile <4 x i32> addrspace(1)* %22, align 16
...
; <label>:28                                      ; preds = %26, %21
  ...
  %30 = load volatile <4 x i32> addrspace(1)* %29, align 16
...
; <label>:35                                      ; preds = %33, %28
  ...
  %37 = load volatile <4 x i32> addrspace(1)* %36, align 16
...
; <label>:43                                      ; preds = %42
  %44 = add i32 %i.0, 1
  %45 = call i32 @__get_global_size_u32(i32 0)
  %46 = add i32 %idx.0, %45
  br label %12
...
; <label>:50                                      ; preds = %8
  ...
  call void @barrier(i32 1)
  %52 = call i32 @__get_local_id_u32(i32 0)
  %53 = icmp eq i32 %52, 0
...
; <label>:54                                      ; preds = %50
  ...
  %56 = udiv i32 %55, %nk
  %57 = call i32 @__get_group_id_u32(i32 0)
  %58 = getelementptr inbounds i32 addrspace(1)* %out, i32 %57
  store volatile i32 %56, i32 addrspace(1)* %58, align 4
  br label %59
...
; <label>:14                                      ; preds = %12
  ...
  store volatile <4 x i32> %7, <4 x i32> addrspace(1)* %15, align 16
  br label %16

; <label>:16                                      ; preds = %14
  %17 = add i32 %i.0, 1
  %18 = call i32 @__get_global_size_u32(i32 0)
  %19 = add i32 %idx.0, %18
  br label %12
