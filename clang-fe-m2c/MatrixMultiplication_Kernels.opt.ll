...
define void @mmmKernel(<4 x float> addrspace(1)* %matrixA, <4 x float> addrspace(1)* %matrixB, <4 x float> addrspace(1)* %matrixC, i32 %widthA, i32 %widthB) #0 {
  ...
  %3 = call i32 @__get_global_id_u32(i32 1)
...
define void @mmmKernel_local(<4 x float> addrspace(1)* %matrixA, <4 x float> addrspace(1)* %matrixB, <4 x float> addrspace(1)* %matrixC, i32 %widthA, <4 x float> addrspace(3)* %blockA) #0 {
  ...
  %3 = call i32 @__get_local_id_u32(i32 1)
  %4 = shl i32 %3, 2
  %5 = mul i32 %2, %4
  %6 = add i32 %1, %5
...
; <label>:14                                      ; preds = %365, %0
  ...
  %15 = call i32 @__get_local_size_u32(i32 0)
  %16 = udiv i32 %13, %15
  %17 = icmp ult i32 %i.0, %16
  br i1 %17, label %18, label %367

; <label>:18                                      ; preds = %14
  %19 = call i32 @__get_local_size_u32(i32 0)
  %20 = mul i32 %i.0, %19
  %21 = call i32 @__get_local_id_u32(i32 0)
  %22 = add i32 %20, %21
  %23 = call i32 @__get_global_id_u32(i32 1)
  %24 = shl i32 %23, 2
  %25 = mul i32 %24, %13
  %26 = add i32 %22, %25
  ...
  %33 = call i32 @__get_local_size_u32(i32 0)
  %34 = add i32 %6, %33
  ...
  %40 = call i32 @__get_local_size_u32(i32 0)
  %41 = mul i32 2, %40
  %42 = add i32 %6, %41
  ...
  %48 = call i32 @__get_local_size_u32(i32 0)
  %49 = mul i32 3, %48
  %50 = add i32 %6, %49
  %51 = getelementptr inbounds <4 x float> addrspace(3)* %blockA, i32 %50
  store <4 x float> %47, <4 x float> addrspace(3)* %51, align 16
  call void @barrier(i32 1)
  %52 = call i32 @__get_global_id_u32(i32 0)
  %53 = call i32 @__get_local_size_u32(i32 0)
  %54 = mul i32 %i.0, %53
  %55 = shl i32 %54, 2
  %56 = call i32 @__get_global_size_u32(i32 0)
  %57 = mul i32 %55, %56
  %58 = add i32 %52, %57
  br label %59
...
; <label>:59                                      ; preds = %362, %18
  ...
  %60 = call i32 @__get_local_size_u32(i32 0)
  %61 = mul i32 %60, 4
...
; <label>:63                                      ; preds = %59
  %64 = ashr i32 %j.0, 2
  %65 = call i32 @__get_local_id_u32(i32 1)
  %66 = mul i32 %65, 4
  %67 = call i32 @__get_local_size_u32(i32 0)
  %68 = mul i32 %66, %67
  %69 = add i32 %64, %68
  %70 = getelementptr inbounds <4 x float> addrspace(3)* %blockA, i32 %69
  %71 = load <4 x float> addrspace(3)* %70, align 16
  %72 = ashr i32 %j.0, 2
  %73 = call i32 @__get_local_id_u32(i32 1)
  %74 = mul i32 %73, 4
  %75 = add i32 %74, 1
  ...
  %105 = call i32 @__get_global_size_u32(i32 0)
  %106 = mul i32 %104, %105
  %107 = add i32 %58, %106
  ...
  %111 = call i32 @__get_global_size_u32(i32 0)
  %112 = mul i32 %110, %111
  %113 = add i32 %58, %112
  ...
  %117 = call i32 @__get_global_size_u32(i32 0)
  %118 = mul i32 %116, %117
  %119 = add i32 %58, %118
...
; <label>:367                                     ; preds = %14
  ...
  %369 = call i32 @__get_global_size_u32(i32 0)
  %370 = add i32 %12, %369
  ...
  %372 = call i32 @__get_global_size_u32(i32 0)
  %373 = mul i32 2, %372
  %374 = add i32 %12, %373
  ...
  %376 = call i32 @__get_global_size_u32(i32 0)
  %377 = mul i32 3, %376
  %378 = add i32 %12, %377
