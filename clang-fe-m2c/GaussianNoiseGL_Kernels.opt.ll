...
define void @gaussian_transform(<4 x i8> addrspace(1)* %inputImage, %opencl.image2d_t* %outputImage, i32 %factor) #0 {
  ...
  %2 = call i32 @__get_global_size_u32(i32 0)
  %3 = mul i32 2, %2
  %4 = call i32 @__get_global_id_u32(i32 1)
  %5 = mul i32 %3, %4
  %6 = add i32 %1, %5
  %7 = call i32 @__get_global_id_u32(i32 0)
  %8 = call i32 @__get_global_size_u32(i32 0)
  %9 = add i32 %7, %8
  %10 = call i32 @__get_global_size_u32(i32 0)
  %11 = mul i32 2, %10
  %12 = call i32 @__get_global_id_u32(i32 1)
  %13 = mul i32 %11, %12
  %14 = add i32 %9, %13
  ...
  %60 = call i32 @__get_global_id_u32(i32 0)
  %61 = insertelement <2 x i32> undef, i32 %60, i32 0
  %62 = call i32 @__get_global_id_u32(i32 1)
  %63 = insertelement <2 x i32> %61, i32 %62, i32 1
  %64 = call i32 @__get_global_id_u32(i32 0)
  %65 = call i32 @__get_global_size_u32(i32 0)
  %66 = add i32 %64, %65
  %67 = insertelement <2 x i32> undef, i32 %66, i32 0
  %68 = call i32 @__get_global_id_u32(i32 1)
