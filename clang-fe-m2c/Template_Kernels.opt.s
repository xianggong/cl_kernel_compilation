...
:
	...
	s_waitcnt vmcnt(0)
	v_mov_b32 v13, s36
	v_mul_lo_u32 v14, v12, v13
	v_mov_b32 v15, s22
	v_mul_i32_i24 v17, 0x4, v3
	v_add_i32 v16, vcc, v17, v15
	tbuffer_store_format_x v14, v16, s[24:27], 0x0 offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt expcnt(0)
	s_endpgm 
