...
for.end:                                          ; preds = %for.cond
  ...
  %call = call cc75 <4 x float> @_Z14convert_float4Dv4_j(<4 x i32> %41) #1
  ...
  %call65 = call cc75 <4 x float> @_Z14convert_float4Dv4_j(<4 x i32> %42) #1
  ...
  %call68 = call cc75 <4 x float> @_Z3logDv4_f(<4 x float> %div) #1
  ...
  %mul71 = fmul <4 x float> <float 0x401921FB60000000, float 0x401921FB60000000, float 0x401921FB60000000, float 0x401921FB60000000>, %div67
  %call72 = call cc75 <4 x float> @_Z3cosDv4_f(<4 x float> %mul71) #1
  %mul73 = fmul <4 x float> %call70, %call72
  store <4 x float> %mul73, <4 x float>* %gaussianRand1, align 16
  %call74 = call cc75 <4 x float> @_Z3sinDv4_f(<4 x float> %mul71) #1
  %mul75 = fmul <4 x float> %call70, %call74
  store <4 x float> %mul75, <4 x float>* %gaussianRand2, align 16
...
if.then:                                          ; preds = %entry
  %1 = insertelement <4 x float> zeroinitializer, float 1.000000e+00, i32 0
  %2 = extractelement <4 x float> %sub, i32 0
  %3 = insertelement <4 x float> zeroinitializer, float %2, i32 0
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %temp1.0 = phi <4 x float> [ %1, %if.then ], [ zeroinitializer, %entry ]
  %temp3.0 = phi <4 x float> [ %3, %if.then ], [ zeroinitializer, %entry ]
  %4 = extractelement <4 x float> %sub, i32 1
  %cmp2 = fcmp ogt float %4, 0.000000e+00
  br i1 %cmp2, label %if.then3, label %if.end4

if.then3:                                         ; preds = %if.end
  %5 = insertelement <4 x float> %temp1.0, float 1.000000e+00, i32 1
  %6 = extractelement <4 x float> %sub, i32 1
  %7 = insertelement <4 x float> %temp3.0, float %6, i32 1
  br label %if.end4

if.end4:                                          ; preds = %if.then3, %if.end
  %temp1.1 = phi <4 x float> [ %5, %if.then3 ], [ %temp1.0, %if.end ]
  %temp3.1 = phi <4 x float> [ %7, %if.then3 ], [ %temp3.0, %if.end ]
  %8 = extractelement <4 x float> %sub, i32 2
  %cmp5 = fcmp ogt float %8, 0.000000e+00
  br i1 %cmp5, label %if.then6, label %if.end7

if.then6:                                         ; preds = %if.end4
  %9 = insertelement <4 x float> %temp1.1, float 1.000000e+00, i32 2
  %10 = extractelement <4 x float> %sub, i32 2
  %11 = insertelement <4 x float> %temp3.1, float %10, i32 2
  br label %if.end7

if.end7:                                          ; preds = %if.then6, %if.end4
  %temp1.2 = phi <4 x float> [ %9, %if.then6 ], [ %temp1.1, %if.end4 ]
  %temp3.2 = phi <4 x float> [ %11, %if.then6 ], [ %temp3.1, %if.end4 ]
  %12 = extractelement <4 x float> %sub, i32 3
  %cmp8 = fcmp ogt float %12, 0.000000e+00
  br i1 %cmp8, label %if.then9, label %if.end10

if.then9:                                         ; preds = %if.end7
  %13 = insertelement <4 x float> %temp1.2, float 1.000000e+00, i32 3
  %14 = extractelement <4 x float> %sub, i32 3
  %15 = insertelement <4 x float> %temp3.2, float %14, i32 3
  br label %if.end10

if.end10:                                         ; preds = %if.then9, %if.end7
  %temp1.3 = phi <4 x float> [ %13, %if.then9 ], [ %temp1.2, %if.end7 ]
  %temp3.3 = phi <4 x float> [ %15, %if.then9 ], [ %temp3.2, %if.end7 ]
  %16 = extractelement <4 x float> %sub1, i32 0
  %cmp11 = fcmp ogt float %16, 0.000000e+00
  br i1 %cmp11, label %if.then12, label %if.end13

if.then12:                                        ; preds = %if.end10
  %17 = insertelement <4 x float> zeroinitializer, float 1.000000e+00, i32 0
  %18 = extractelement <4 x float> %sub1, i32 0
  %19 = insertelement <4 x float> zeroinitializer, float %18, i32 0
  br label %if.end13

if.end13:                                         ; preds = %if.then12, %if.end10
  %temp2.0 = phi <4 x float> [ %17, %if.then12 ], [ zeroinitializer, %if.end10 ]
  %temp4.0 = phi <4 x float> [ %19, %if.then12 ], [ zeroinitializer, %if.end10 ]
  %20 = extractelement <4 x float> %sub1, i32 1
  %cmp14 = fcmp ogt float %20, 0.000000e+00
  br i1 %cmp14, label %if.then15, label %if.end16

if.then15:                                        ; preds = %if.end13
  %21 = insertelement <4 x float> %temp2.0, float 1.000000e+00, i32 1
  %22 = extractelement <4 x float> %sub1, i32 1
  %23 = insertelement <4 x float> %temp4.0, float %22, i32 1
  br label %if.end16

if.end16:                                         ; preds = %if.then15, %if.end13
  %temp2.1 = phi <4 x float> [ %21, %if.then15 ], [ %temp2.0, %if.end13 ]
  %temp4.1 = phi <4 x float> [ %23, %if.then15 ], [ %temp4.0, %if.end13 ]
  %24 = extractelement <4 x float> %sub1, i32 2
  %cmp17 = fcmp ogt float %24, 0.000000e+00
  br i1 %cmp17, label %if.then18, label %if.end19

if.then18:                                        ; preds = %if.end16
  %25 = insertelement <4 x float> %temp2.1, float 1.000000e+00, i32 2
  %26 = extractelement <4 x float> %sub1, i32 2
  %27 = insertelement <4 x float> %temp4.1, float %26, i32 2
  br label %if.end19

if.end19:                                         ; preds = %if.then18, %if.end16
  %temp2.2 = phi <4 x float> [ %25, %if.then18 ], [ %temp2.1, %if.end16 ]
  %temp4.2 = phi <4 x float> [ %27, %if.then18 ], [ %temp4.1, %if.end16 ]
  %28 = extractelement <4 x float> %sub1, i32 3
  %cmp20 = fcmp ogt float %28, 0.000000e+00
  br i1 %cmp20, label %if.then21, label %if.end22

if.then21:                                        ; preds = %if.end19
  %29 = insertelement <4 x float> %temp2.2, float 1.000000e+00, i32 3
  %30 = extractelement <4 x float> %sub1, i32 3
  %31 = insertelement <4 x float> %temp4.2, float %30, i32 3
  br label %if.end22

if.end22:                                         ; preds = %if.then21, %if.end19
  %temp2.3 = phi <4 x float> [ %29, %if.then21 ], [ %temp2.2, %if.end19 ]
  %temp4.3 = phi <4 x float> [ %31, %if.then21 ], [ %temp4.2, %if.end19 ]
  %mul = fmul <4 x float> %meanDeriv1, %temp1.3
  store <4 x float> %mul, <4 x float>* %pathDeriv1, align 16
  %mul23 = fmul <4 x float> %meanDeriv2, %temp2.3
  store <4 x float> %mul23, <4 x float>* %pathDeriv2, align 16
...
for.cond:                                         ; preds = %for.inc, %entry
  %trajPrice1.0 = phi <4 x float> [ %4, %entry ], [ %mul12, %for.inc ]
  %trajPrice2.0 = phi <4 x float> [ %4, %entry ], [ %mul15, %for.inc ]
  %sumPrice1.0 = phi <4 x float> [ %4, %entry ], [ %add16, %for.inc ]
  %sumPrice2.0 = phi <4 x float> [ %4, %entry ], [ %add17, %for.inc ]
  %sumDeriv1.0 = phi <4 x float> [ zeroinitializer, %entry ], [ %14, %for.inc ]
  %sumDeriv2.0 = phi <4 x float> [ zeroinitializer, %entry ], [ %15, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  ...
  call cc75 void @generateRand(<4 x i32> %8, <4 x float>* %finalRandf1, <4 x float>* %finalRandf2, <4 x i32>* %nextRand)
  %9 = load <4 x float>* %finalRandf1, align 16
  %10 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %2, <4 x float> %9, <4 x float> %1)
  %call11 = call cc75 <4 x float> @_Z3expDv4_f(<4 x float> %10) #1
  %mul12 = fmul <4 x float> %trajPrice1.0, %call11
  %11 = load <4 x float>* %finalRandf2, align 16
  %12 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %2, <4 x float> %11, <4 x float> %1)
  %call14 = call cc75 <4 x float> @_Z3expDv4_f(<4 x float> %12) #1
  %mul15 = fmul <4 x float> %trajPrice2.0, %call14
  %add16 = fadd <4 x float> %sumPrice1.0, %mul12
  %add17 = fadd <4 x float> %sumPrice2.0, %mul15
  %mul18 = fmul <4 x float> %3, %6
  %conv19 = sitofp i32 %i.0 to float
  %13 = insertelement <4 x float> undef, float %conv19, i32 0
  %splat = shufflevector <4 x float> %13, <4 x float> %13, <4 x i32> zeroinitializer
  %mul20 = fmul <4 x float> %mul18, %splat
  %div = fdiv <4 x float> %mul12, %4, !fpmath !7
  %call21 = call cc75 <4 x float> @_Z3logDv4_f(<4 x float> %div) #1
  %sub = fsub <4 x float> %call21, %mul20
  %div22 = fdiv <4 x float> %sub, %5, !fpmath !7
  %14 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mul12, <4 x float> %div22, <4 x float> %sumDeriv1.0)
  %div24 = fdiv <4 x float> %mul15, %4, !fpmath !7
  %call25 = call cc75 <4 x float> @_Z3logDv4_f(<4 x float> %div24) #1
  %sub26 = fsub <4 x float> %call25, %mul20
  %div27 = fdiv <4 x float> %sub26, %5, !fpmath !7
  %15 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mul15, <4 x float> %div27, <4 x float> %sumDeriv2.0)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %16 = insertelement <4 x float> undef, float %conv29, i32 0
  %splat30 = shufflevector <4 x float> %16, <4 x float> %16, <4 x i32> zeroinitializer
  %div31 = fdiv <4 x float> %sumPrice1.0, %splat30, !fpmath !7
  %conv32 = sitofp i32 %noOfSum to float
  %17 = insertelement <4 x float> undef, float %conv32, i32 0
  %splat33 = shufflevector <4 x float> %17, <4 x float> %17, <4 x i32> zeroinitializer
  %div34 = fdiv <4 x float> %sumPrice2.0, %splat33, !fpmath !7
  %conv35 = sitofp i32 %noOfSum to float
  %18 = insertelement <4 x float> undef, float %conv35, i32 0
  %splat36 = shufflevector <4 x float> %18, <4 x float> %18, <4 x i32> zeroinitializer
  %div37 = fdiv <4 x float> %sumDeriv1.0, %splat36, !fpmath !7
  %conv38 = sitofp i32 %noOfSum to float
  %19 = insertelement <4 x float> undef, float %conv38, i32 0
  %splat39 = shufflevector <4 x float> %19, <4 x float> %19, <4 x i32> zeroinitializer
  %div40 = fdiv <4 x float> %sumDeriv2.0, %splat39, !fpmath !7
  call cc75 void @calOutputs(<4 x float> %0, <4 x float> %div37, <4 x float> %div40, <4 x float> %div31, <4 x float> %div34, <4 x float>* %pathDeriv1, <4 x float>* %pathDeriv2, <4 x float>* %price1, <4 x float>* %price2)
  %20 = load <4 x float>* %price1, align 16
  %conv41 = sext i32 %width to i64
  %mul42 = mul i64 %call8, %conv41
  %add43 = add i64 %mul42, %call
  %mul44 = mul i64 %add43, 2
  %arrayidx45 = getelementptr inbounds <4 x float> addrspace(1)* %priceSamples, i64 %mul44
  store <4 x float> %20, <4 x float> addrspace(1)* %arrayidx45, align 16
  %21 = load <4 x float>* %price2, align 16
  %conv46 = sext i32 %width to i64
  %mul47 = mul i64 %call8, %conv46
  %add48 = add i64 %mul47, %call
  %mul49 = mul i64 %add48, 2
  %add50 = add i64 %mul49, 1
  %arrayidx51 = getelementptr inbounds <4 x float> addrspace(1)* %priceSamples, i64 %add50
  store <4 x float> %21, <4 x float> addrspace(1)* %arrayidx51, align 16
  %22 = load <4 x float>* %pathDeriv1, align 16
  %conv52 = sext i32 %width to i64
  %mul53 = mul i64 %call8, %conv52
  %add54 = add i64 %mul53, %call
  %mul55 = mul i64 %add54, 2
  %arrayidx56 = getelementptr inbounds <4 x float> addrspace(1)* %pathDeriv, i64 %mul55
  store <4 x float> %22, <4 x float> addrspace(1)* %arrayidx56, align 16
  %23 = load <4 x float>* %pathDeriv2, align 16
  %conv57 = sext i32 %width to i64
  %mul58 = mul i64 %call8, %conv57
  %add59 = add i64 %mul58, %call
  %mul60 = mul i64 %add59, 2
  %add61 = add i64 %mul60, 1
  %arrayidx62 = getelementptr inbounds <4 x float> addrspace(1)* %pathDeriv, i64 %add61
  store <4 x float> %23, <4 x float> addrspace(1)* %arrayidx62, align 16
  ret void
}
