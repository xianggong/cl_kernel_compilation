; ModuleID = 'DeviceFission11Ext_Kernels.opt.bc'
...
entry:
  ...
  %arrayidx = getelementptr inbounds float addrspace(1)* %input, i64 %call
  %0 = load float addrspace(1)* %arrayidx, align 4
  %arrayidx1 = getelementptr inbounds float addrspace(1)* %output, i64 %call
  store float %0, float addrspace(1)* %arrayidx1, align 4
  ret void
}
