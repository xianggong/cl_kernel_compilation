...
if.end13:                                         ; preds = %if.then12, %for.body9
  ...
  %2 = load <4 x i32> addrspace(1)* %arrayidx15, align 16
...
if.end20:                                         ; preds = %if.then18, %if.end13
  ...
  %4 = load <4 x i32> addrspace(1)* %arrayidx22, align 16
...
if.end27:                                         ; preds = %if.then25, %if.end20
  ...
  %6 = load <4 x i32> addrspace(1)* %arrayidx29, align 16
...
if.then46:                                        ; preds = %for.end41
  ...
  store i32 %div, i32 addrspace(1)* %arrayidx48, align 4
  br label %if.end49
...
for.body8:                                        ; preds = %for.cond5
  ...
  store <4 x i32> %vecinit3, <4 x i32> addrspace(1)* %arrayidx, align 16
  br label %for.inc
