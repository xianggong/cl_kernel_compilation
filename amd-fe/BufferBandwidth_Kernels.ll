; ModuleID = 'BufferBandwidth_Kernels.bc'
...
if.end13:                                         ; preds = %if.then12, %for.body9
  ...
  %13 = load <4 x i32> addrspace(1)* %arrayidx15, align 16
...
if.end20:                                         ; preds = %if.then18, %if.end13
  ...
  %19 = load <4 x i32> addrspace(1)* %arrayidx22, align 16
...
if.end27:                                         ; preds = %if.then25, %if.end20
  ...
  %25 = load <4 x i32> addrspace(1)* %arrayidx29, align 16
