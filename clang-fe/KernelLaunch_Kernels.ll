...
._crit_edge8:                                     ; preds = %._crit_edge
  %31 = tail call i32 @_Z10atomic_addPVU7CLlocaljj(i32* @read_kernel.lcount, i32 %pcount.1.lcssa) #2
  tail call void @barrier(i32 1) #2
...
; <label>:34                                      ; preds = %._crit_edge8
  %35 = load i32* @read_kernel.lcount, align 4, !tbaa !3
  %36 = udiv i32 %35, %nk
...
.lr.ph:                                           ; preds = %7, %.lr.ph
  ...
  store volatile <4 x i32> %5, <4 x i32>* %10, align 16, !tbaa !7
  %11 = add i32 %i.02, 1
