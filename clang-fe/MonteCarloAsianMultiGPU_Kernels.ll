...
; Function Attrs: nounwind uwtable
define void @calPriceVega(%struct._MonteCalroAttrib* byval nocapture readonly align 16 %attrib, i32 %noOfSum, i32 %width, <4 x i32>* nocapture readonly %randArray, <4 x float>* nocapture %priceSamples, <4 x float>* nocapture %pathDeriv) #0 {
  ...
  %15 = tail call i64 @get_global_id(i32 0) #1
  %16 = tail call i64 @get_global_id(i32 1) #1
  ...
  %18 = mul i64 %16, %17
  %19 = add i64 %18, %15
  %20 = getelementptr inbounds <4 x i32>* %randArray, i64 %19
  %21 = load <4 x i32>* %20, align 16, !tbaa !2
...
calOutputs.exit:                                  ; preds = %100, %103
  ...
  %108 = shl i64 %19, 1
  %109 = getelementptr inbounds <4 x float>* %priceSamples, i64 %108
  store <4 x float> %temp3.3.i, <4 x float>* %109, align 16, !tbaa !2
  %110 = or i64 %108, 1
  %111 = getelementptr inbounds <4 x float>* %priceSamples, i64 %110
  store <4 x float> %temp4.3.i, <4 x float>* %111, align 16, !tbaa !2
  %112 = getelementptr inbounds <4 x float>* %pathDeriv, i64 %108
  store <4 x float> %106, <4 x float>* %112, align 16, !tbaa !2
  %113 = getelementptr inbounds <4 x float>* %pathDeriv, i64 %110
  store <4 x float> %107, <4 x float>* %113, align 16, !tbaa !2
  ret void
}
...
!0 = metadata !{void (%struct._MonteCalroAttrib*, i32, i32, <4 x i32>*, <4 x float>*, <4 x float>*)* @calPriceVega}
