...
define void @copy(float* nocapture readonly %input, float* nocapture %output) #0 {
  %1 = tail call i64 @get_global_id(i32 0) #2
  %2 = getelementptr inbounds float* %input, i64 %1
  %3 = load float* %2, align 4, !tbaa !2
  %4 = getelementptr inbounds float* %output, i64 %1
...
!0 = metadata !{void (float*, float*)* @copy}
