...
lor.lhs.false5:                                   ; preds = %entry
  %sub6 = add i32 %call2, -1
  %sub7 = sub i32 %sub6, %div
  %cmp8 = icmp sgt i32 %call, %sub7
  br i1 %cmp8, label %if.then, label %lor.lhs.false9

lor.lhs.false9:                                   ; preds = %lor.lhs.false5
  %sub10 = add i32 %call3, -1
  %sub11 = sub i32 %sub10, %div
  %cmp12 = icmp sgt i32 %call1, %sub11
  br i1 %cmp12, label %if.then, label %if.end

if.then:                                          ; preds = %lor.lhs.false9, %lor.lhs.false5, %entry
...
if.end:                                           ; preds = %lor.lhs.false9
  ...
  %add18 = add nsw i32 %div, %call
  %add25 = add nsw i32 %div, %call1
