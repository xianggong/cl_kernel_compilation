...
; <label>:21                                      ; preds = %17, %13, %0
  ...
  %25 = getelementptr inbounds <4 x i8>* %outputImage, i64 %24
  store <4 x i8> zeroinitializer, <4 x i8>* %25, align 4, !tbaa !8
  br label %78
...
; <label>:26                                      ; preds = %17
  ...
  %or.cond2 = and i1 %36, %37
  br i1 %or.cond2, label %38, label %45

; <label>:38                                      ; preds = %26
  %39 = mul nsw i32 %35, %6
  %40 = add nsw i32 %39, %34
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds <4 x i32>* %inputImage, i64 %41
  %43 = load <4 x i32>* %42, align 16, !tbaa !8
  %44 = tail call <4 x i32> @_Z12convert_int4Dv4_j(<4 x i32> %43) #3
  br label %45

; <label>:45                                      ; preds = %38, %26
  %sumA.0 = phi <4 x i32> [ %44, %38 ], [ zeroinitializer, %26 ]
  %46 = icmp sgt i32 %32, -1
  %or.cond3 = and i1 %46, %37
...
; <label>:47                                      ; preds = %45
  ...
  %51 = getelementptr inbounds <4 x i32>* %inputImage, i64 %50
  %52 = load <4 x i32>* %51, align 16, !tbaa !8
  %53 = tail call <4 x i32> @_Z12convert_int4Dv4_j(<4 x i32> %52) #3
  br label %54

; <label>:54                                      ; preds = %47, %45
  %sumB.0 = phi <4 x i32> [ %53, %47 ], [ zeroinitializer, %45 ]
  %55 = icmp sgt i32 %33, -1
  %or.cond4 = and i1 %36, %55
  %56 = mul nsw i32 %33, %6
  br i1 %or.cond4, label %57, label %._crit_edge

; <label>:57                                      ; preds = %54
  %58 = add nsw i32 %34, %56
  %59 = sext i32 %58 to i64
  %60 = getelementptr inbounds <4 x i32>* %inputImage, i64 %59
  %61 = load <4 x i32>* %60, align 16, !tbaa !8
  %62 = tail call <4 x i32> @_Z12convert_int4Dv4_j(<4 x i32> %61) #3
  br label %._crit_edge

._crit_edge:                                      ; preds = %54, %57
  %sumD.0 = phi <4 x i32> [ %62, %57 ], [ zeroinitializer, %54 ]
  %63 = add nsw i32 %56, %32
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds <4 x i32>* %inputImage, i64 %64
  %66 = load <4 x i32>* %65, align 16, !tbaa !8
  %67 = tail call <4 x i32> @_Z12convert_int4Dv4_j(<4 x i32> %66) #3
  %68 = add <4 x i32> %sumA.0, %67
  %69 = sub <4 x i32> %68, %sumB.0
  %70 = sub <4 x i32> %69, %sumD.0
  %71 = sdiv <4 x i32> %70, %29
  %72 = tail call i32 @_Z14convert_uchar4Dv4_i(<4 x i32> %71) #3
  %73 = bitcast i32 %72 to <4 x i8>
  %74 = mul i64 %5, %3
  %75 = add i64 %74, %1
  %sext = shl i64 %75, 32
  %76 = ashr exact i64 %sext, 32
  %77 = getelementptr inbounds <4 x i8>* %outputImage, i64 %76
  store <4 x i8> %73, <4 x i8>* %77, align 4, !tbaa !8
  br label %78

; <label>:78                                      ; preds = %._crit_edge, %21
  ret void
}
