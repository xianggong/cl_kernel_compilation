...
._crit_edge8:                                     ; preds = %._crit_edge
  %28 = tail call i32 @_Z10atomic_addPVU3AS3jj(i32 addrspace(3)* @read_kernel.lcount, i32 %pcount.1.lcssa) #2
  tail call void @barrier(i32 1) #2
...
; <label>:31                                      ; preds = %._crit_edge8
  %32 = load i32 addrspace(3)* @read_kernel.lcount, align 4, !tbaa !3
  %33 = udiv i32 %32, %nk
  %34 = tail call i32 @get_group_id(i32 0) #2
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds i32 addrspace(1)* %out, i64 %35
  store i32 %33, i32 addrspace(1)* %36, align 4, !tbaa !3
  br label %37

; <label>:37                                      ; preds = %0, %31, %._crit_edge8
  ret void
}
...
.lr.ph:                                           ; preds = %7, %.lr.ph
  ...
  store <4 x i32> %5, <4 x i32> addrspace(1)* %10, align 16, !tbaa !7
  %11 = add i32 %i.02, 1
