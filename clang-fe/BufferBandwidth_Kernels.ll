...
if.then35:                                        ; preds = %for.end31
  %6 = load i32 addrspace(3)* @read_kernel.lcount, align 4, !tbaa !3
  %div = udiv i32 %6, %nk
  %call36 = tail call i32 @get_group_id(i32 0) #2
  %7 = sext i32 %call36 to i64
  %arrayidx37 = getelementptr inbounds i32 addrspace(1)* %out, i64 %7
  store i32 %div, i32 addrspace(1)* %arrayidx37, align 4, !tbaa !3
  br label %if.end38
...
for.body7:                                        ; preds = %for.body, %for.body7
  ...
  store <4 x i32> %vecinit3, <4 x i32> addrspace(1)* %arrayidx, align 16, !tbaa !7
  %inc = add i32 %i.021, 1
